...
class DiseaseRAGSystem:
    ...
    def calculate_disease_scores(self, matched_symptoms):
        """
        Calculate scores for each disease based on matched symptoms using base score model
        and normalize them using Confidence-Weighted Softmax.
        """
        ...
        # Base scoring model (your best-performing formula)
    ...
    def diagnose(self, query, top_k=3, similarity_threshold=0.45):
        """
        Diagnose disease from user query.
        """
